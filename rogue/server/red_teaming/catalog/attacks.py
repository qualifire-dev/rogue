...
- PREMIUM attacks: Require Deckard service (ROGUE_SECURITY_API_KEY)

Premium attacks are NOT implemented locally - they are generated by the
Rogue Security premium attack service via the API.
"""
...
def get_deckard_required_attacks() -> List[str]:
    ...
    the Deckard API with a ROGUE_SECURITY_API_KEY.
    """
...
def get_full_scan_attacks() -> List[str]:
    ...
    Note: Premium attacks require ROGUE_SECURITY_API_KEY to use.
    """
