"""
Red Team A2A Evaluator Agent.

Extends A2AEvaluatorAgent with red teaming capabilities.
"""
...
# Red Team Agent Instructions Template
...
class RedTeamA2AEvaluatorAgent(A2AEvaluatorAgent):
    """
    Red team evaluator agent for A2A protocol.

    Extends A2AEvaluatorAgent with OWASP Top 10 attack capabilities.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize Red Team A2A Evaluator Agent.
    ...
    def get_underlying_agent(self) -> "LlmAgent":
        ...
        logger.info(
            "🔴 Creating Red Team A2A LLM agent",
            extra={
